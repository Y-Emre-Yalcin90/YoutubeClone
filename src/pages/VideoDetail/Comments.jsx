    ...
    <div className="my-6">
      ...
      {data.data.map((i, key) => (
        <div key={key} className="flex gap-2 items-start px-1 py-4">
          <img className="w-10 h-10 rounded-full" src={comment.authorThumbnail[0].url} alt="logo"  />
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-5 items-center">
              ...
              <div className="p-1 rounded cursor-pointer hover:bg-zinc-700">
                <AiOutlineDislike/>
                <button className="p-1 rounded cursor-pointer hover:bg-zinc-700">Yanitla</button>
              </div>
